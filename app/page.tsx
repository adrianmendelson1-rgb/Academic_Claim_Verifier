  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "var(--background)" }}>
      ...
      <header className="sticky top-0 z-20 border-b overflow-hidden flex-shrink-0"
        ...
        <div className="max-w-7xl mx-auto pl-1 pr-10 h-14 flex items-center justify-between">
          <span className="text-[20px] font-semibold text-[#1A1A18] tracking-tight">Claim Verifier</span>
